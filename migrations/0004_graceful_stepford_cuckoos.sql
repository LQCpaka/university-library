CREATE TABLE "borrow_books" (
	...
	CONSTRAINT "borrow_books_id_unique" UNIQUE("id")
);
--> statement-breakpoint
ALTER TABLE "borrow_books" ADD CONSTRAINT "borrow_books_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
